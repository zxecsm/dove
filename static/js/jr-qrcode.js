            ...
            value: function (t) {
              ...
              for (var e = Object(t), r = 1; r < arguments.length; r++) {
                ...
                if (void 0 !== o && null !== o) {
                  o = Object(o);
                  for (
                    var n = Object.keys(Object(o)), i = 0, a = n.length;
                    i < a;
                    i++
                  ) {
                    var s = n[i],
          ...
          function t(t) {
            ...
            for (var s = 0; s < e.getModuleCount(); s++)
              for (var u = 0; u < e.getModuleCount(); u++) {
                ...
                o.fillRect(
                  Math.round(u * n) + t.padding,
                  Math.round(s * i) + t.padding,
                  h,
                  f
                );
              }
    ...
    function (t, e) {
      ...
      (r.prototype = {
                ...
                if (null == this.modules[o][n])
                  for (var i = -2; i <= 2; i++)
                    for (var a = -2; a <= 2; a++)
                      ...
                      2 == a ||
                      (0 == i && 0 == a)
                        ? (this.modules[o + i][n + a] = !0)
                        : (this.modules[o + i][n + a] = !1);
              }
          },
          setupTypeNumber: function (t) {
            for (
              var e = f.getBCHTypeNumber(this.typeNumber), r = 0;
              r < 18;
              r++
            ) {
              var o = !t && 1 == ((e >> r) & 1);
        ...
        (o.createData = function (t, e, r) {
          for (
            var n = i.getRSBlocks(t, e), s = new a(), u = 0;
            u < r.length;
            u++
          ) {
            var h = r[u];
      ...
      (n.prototype = {
        ...
        (i.getRSBlocks = function (t, e) {
          ...
          for (var o = r.length / 3, n = new Array(), a = 0; a < o; a++)
            for (
              var s = r[3 * a + 0], u = r[3 * a + 1], h = r[3 * a + 2], f = 0;
              f < s;
              f++
            )
              n.push(new i(u, h));
